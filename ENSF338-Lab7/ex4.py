            ...
            if ((balance == 1 and data < pivot.data) or
                ...
                if pivot_index + 1 < len(path):
                    ...
                    if (balance == -1 and data < son.data) or (balance == 1 and data > son.data):
                        ...
                        print("Case #3b: Adding a node to the inside subtree.")
                        if balance == -1:
                            root = self._lr_rotate(pivot)
                        else:
                            root = self._rl_rotate(pivot)
...
root = tree.insert(root, 3)  
root = tree.insert(root, 4) 
print("TESTING CASE 3b Again DONE...\n")